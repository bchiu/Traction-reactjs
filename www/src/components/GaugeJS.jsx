...
var GaugeJS = React.createClass({

    render: function() {
        this.value = parseFloat(this.props.value).toFixed(this.props.precision)
        this.value = Math.min(this.value, this.props.max);
        this.value = Math.max(this.value, this.props.min);

        return (
            <div style={styles.container}>
                <canvas id={this.props.id} width='80' height='60' />
                <div style={styles.min}>{this.props.min}</div>
                <div style={styles.max}>{this.props.max}</div>
                <div style={styles.value}>{this.value}</div>
    ...
    componentDidMount: function() {
        ...
        var opts = {
            ...
            lineWidth: 0.67, // The line thickness

            limitMax:    'false',   // If true, the pointer will not go past the end of the gauge
            colorStart:  '#F99E39', // Colors
            colorStop:   '#ED6430', // just experiment with them
        ...
        this.canvas = $("#"+this.props.id);

        this.gauge = new Gauge(this.canvas[0]);
        this.gauge.setOptions(opts); // create sexy gauge!

        this.gauge.minValue = this.props.min;
        this.gauge.maxValue = this.props.max;
        this.gauge.animationSpeed = 1; // set animation speed (32 is default value)

        this.gauge.set(this.props.min);
    },
